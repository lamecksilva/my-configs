...
if isdirectory('./node_modules') && isdirectory('./node_modules/prettier')
  ...
  if isdirectory('./node_modules') && isdirectory('./node_modules/eslint')
   ...
   "  Use templates https://vimtricks.com/p/automated-file-templates/
    " autocmd BufNewFile *.tsx             0r
    " ~/Documents/dotfiles/skeletons/typescript-react.tsx
    " autocmd BufNewFile *content/blog*.md 0r
    " ~/Documents/dotfiles/skeletons/blog-post.md
    " autocmd BufNewFile *.sh              0r
    " ~/Documents/dotfiles/skeletons/script.sh
    " autocmd BufNewFile *.html            0r
    " ~/Documents/dotfiles/skeletons/page.html
